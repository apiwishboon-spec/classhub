...
class Game {
    ...
    moveResultState() {
        ...
        return { turn: this.turn, checked, moves, captures, stalemate };
    }
    randomMove() {
        if (this.active) {
...
class View {
    ...
    drawResetClassNames() {
        document.querySelectorAll("#game-chess .highlight-active").forEach((element) => element.classList.remove("highlight-active"));
        document.querySelectorAll("#game-chess .highlight-capture").forEach((element) => element.classList.remove("highlight-capture"));
        document.querySelectorAll("#game-chess .highlight-move").forEach((element) => element.classList.remove("highlight-move"));
    }
