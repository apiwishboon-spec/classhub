...
const HELP_CONTENT = {
    ...
    hidden_games: {
        en: [
            ...
            { icon: "ph-chess-knight", title: "🎮 Chess vs AI", desc: "Play chess against an AI opponent. Click the help (?) button 4 times to reveal the board." }
        ],
        th: [
            ...
            { icon: "ph-chess-knight", title: "🎮 หมากรุก AI", desc: "เล่นหมากรุกกับ AI กดปุ่มช่วยเหลือ (?) 4 ครั้งเพื่อเปิด" }
        ]
    },
    admin: {
        en: {
