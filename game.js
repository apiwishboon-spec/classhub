(function () {
  ...
  // ─── GAME 3 — CHESS (Cheap AI Chess engine) ──────────────────────────
  function launchChess() {
    const overlay = makeOverlay('game-chess', `
      <div class="gc-modal" style="background:#1a1a2e;border-radius:12px;padding:0.75rem;max-width:560px;width:95%;text-align:center;position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.5);overflow:hidden;">
        ...
        <section id="view">
          <aside>
            ...
            <div>
              ...
              <label for="white-perspective"><input type="radio" name="perspective" id="white-perspective" checked><svg class="white" viewBox="0 0 170 170"><use href="#king"/></svg></label>
              <label for="black-perspective"><input type="radio" name="perspective" id="black-perspective"><svg class="black" viewBox="0 0 170 170"><use href="#king"/></svg></label>
            </div>
          </aside>
          <div id="board"></div>
        </section>
