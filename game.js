(function () {
  ...
  function launchChess() {
    const overlay = makeOverlay('game-chess', `
      <div class="gc-modal" style="background:var(--color-background,#1a1a2e);border-radius:12px;padding:0.75rem;max-width:560px;width:95%;text-align:center;position:relative;box-shadow:0 20px 60px rgba(0,0,0,0.5);overflow:hidden;">
